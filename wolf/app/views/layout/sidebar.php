...
<p class="button">
    <a href="<?php echo get_url('layout/add'); ?>">
        <img src="<?php echo URI_PUBLIC;?>wolf/admin/images/layout.png" align="middle" alt="layout icon" />
        <?php echo __('New Layout'); ?>
    </a>
</p>
<p class="button">
    <a href="<?php echo get_url('layout/discover_layouts'); ?>">
        <img src="<?php echo URI_PUBLIC;?>wolf/admin/images/layout.png" align="middle" alt="layout icon" />
        <?php echo __('Check for filesystem templates'); ?>
    </a>
</p>
