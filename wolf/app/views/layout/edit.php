...
<form action="<?php echo $action=='edit' ? get_url('layout/edit/'. $layout->id): get_url('layout/add'); ; ?>" method="post">
  ...
  <div class="form-area">
    ...
    <p class="content">
      ...
      <textarea class="textarea" cols="40" id="layout_content" name="layout_content" rows="20" style="width: 100%"><?php echo htmlentities($layout_content, ENT_COMPAT, 'UTF-8'); ?></textarea>
    </p>
